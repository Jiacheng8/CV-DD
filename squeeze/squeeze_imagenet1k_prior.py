...
data_dir = "/data/hulk/jiacheng/BSSL_data/imagenet1k"  # where the dataset are stored
save_dir = "/data/hulk/jiacheng/BSSL_data/imagenet1k_models"  # where to save the trained models
...
for model_name in model_lis:
    ...
    for epoch in range(num_epochs):
        ...
        if epoch % 10 == 0 or epoch == num_epochs - 1:
            ...
            torch.save(model.state_dict(), f"{save_dir}/{model_name}_ep{epoch}.pth")
        print("-" * 50)
